...
@CucumberOptions(glue = { "com.qentelli.automation.stepdefs", "com.qentelli.automation.hookse2e" }, plugin = {
		...
		"html:target/site/cucumber-pretty" },tags={"@en_US"}, features = "src/test/resources/features/healthcheck/HCE2EALL")

public class DefaultRunnerE2E2 extends AbstractTestNGCucumberParallelTests {
	static {
