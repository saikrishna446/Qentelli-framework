...
@CucumberOptions(glue = { "com.qentelli.automation.stepdefs", "com.qentelli.automation.hookse2e" }, plugin = {
		...
		"html:target/site/cucumber-pretty" },tags={"@en_CA"}, features = "src/test/resources/features/healthcheck/HCE2EALL")

public class DefaultRunnerE2E4 extends AbstractTestNGCucumberParallelTests {
	static {
